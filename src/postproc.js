...
function resolveCustomProps(css) {
  ...
  while (CUSTOM_PROP_USE.test(css)) {
    // get all defs
    while ((m = CUSTOM_PROP_DEF.exec(css)) !== null)
      defs[m[2]] = m[3]
...
function dropFontFaces(css, flatCss, shouldDrop) {
  ...
  while ((m = RE00.exec(flatCss)) !== null) {
    m2 = RE01.exec(m[0])
  ...
  while ((m = RE02.exec(flatCss)) !== null) {
    if (m[0][0] !== '@')
  ...
  while ((m = RE03.exec(flatCss)) !== null) {
    t = ''
    while ((m2 = RE04.exec(m[1])) !== null)
      t += m2[0]
